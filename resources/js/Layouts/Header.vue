          ...
          />
            ...
            <div class="relative">
                <button @click="dropdownOpen = !dropdownOpen"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-180 -100 800 800">
                        <path
                ...
                <transition enter-active-class="transition duration-150 ease-out transform"
                    ...
                    <div v-show="dropdownOpen" class="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl">
                        ...
                        <ResponsiveNavLink method="post" as="button" :href="route('logout')" class="block px-4 py-2 text-sm
              text-gray-700 hover:bg-indigo-600 hover:text-white">Log out
                        </ResponsiveNavLink>
                    </div>
                </transition>
            </div>
