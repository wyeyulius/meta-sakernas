...
function open(kec) {
    ...
    router.visit(route('admin.kec', { kab : par['kab'], kec : kec }), {
        preserveState: true,
        preserveScroll: true,
    })
}
        ...
        <div class="py-1">
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-between ...">
                    <h2 class="text-lg">Monitoring Realisasi Entri per Kecamatan</h2>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200 overflow-x-auto ">
                        <table class="monitoring w-full text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr v-else v-for="(datum, index) in data" :key="datum.kecamatan"
